...
namespace Invasion.Controller.Controllers
{
    ...
    public class PlayerController : IController
    {
        ...
        public void Update()
        {
            ...
            Rotate();
            if (_weaponBase is not null && _weaponInput.ReadShoot() && _shootTime >= _weaponBase.ReloadTime && _player.CanDamage)
            {
        ...
        private void Rotate()
        {
            if (_weaponBase is not null && _player.TryTakeComponent(out Transform transform))
            {
